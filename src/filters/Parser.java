...
public class Parser {
    ...
    private Filter orexpr() throws SyntaxError {
        ...
        while (token != null && token.equals(OR)) {
            ...
            // Construct a new OrFilter to connect the two subexpressions
            // and assign it to the variable "sub"
    ...
    private Filter andexpr() throws SyntaxError {
        ...
        while (token != null && token.equals(AND)) {
            ...
            // Construct a new AndFilter to connect the two subexpressions
            // and assign it to the variable "sub"
