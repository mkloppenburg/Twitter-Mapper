...
public abstract class TwitterSource extends Observable {
     ...
     *     Inform each active Query (the observers of the TwitterSource object)
     *     about each incoming tweet so that it can determine whether
     *     the tweet should be displayed
     */
